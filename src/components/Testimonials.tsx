  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      image: "/smile.jpg", // ✅ Correct path for Vercel (image in public folder)
    },
    {
      name: "Sai",
      role: "Business man",
    ...
    <section id="testimonials" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-sm uppercase tracking-wider text-teal-600 font-semibold">
            Testimonials
          </h2>
          ...
          <p className="mt-6 text-gray-600">
            ...
            experienced the therapeutic benefits of D.GALISAHEB's massage and
